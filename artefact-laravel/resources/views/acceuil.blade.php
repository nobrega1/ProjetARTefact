            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group row">
                            <label for="passwordconf" class="col-md-4 col-form-label text-md-right">{{ __('Password confirmation') }}</label>

                            <div class="col-md-6">
                                <input id="passwordconf" type="password" class="form-control @error('passwordconf') is-invalid @enderror" name="passwordconf" required autocomplete="passwordconf">
